...
public class MenuMines extends Menu {
    ...
    public MenuMines(MenuElement backButton) {
        super("Mines", 5);
...
//        }));
        ...
        this.setElement(2, new MenuElement(new ItemBuilder(Material.ANVIL, 1).setName("Create").build()).setClickHandler((e, i) -> {
        ...
        this.setupActionableList(10, 9 * 4 - 2, 9 * 4, 9 * 5 - 1, (index) -> {
            ...
            return new MenuElement(getItemForMine(mine))
                    .setClickHandler((e, i) -> {
                        new MenuMine(mine, getBackButton(this).setClickHandler((e1, i1) -> {
                            this.setup();
                            this.open((Player) e1.getWhoClicked());
                        })).open((Player) e.getWhoClicked());
                    }).setDoUpdates(true).setUpdateEvery(10).setUpdateHandler((element) -> element.setItem(getItemForMine(mine)));
        }, 0);
